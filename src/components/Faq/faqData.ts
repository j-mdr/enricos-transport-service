...
export const faqData: LocalizedData<FaqAccordionSectionData> = {
  nl: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: `Gebruik het contact formulier via het menu. Liever persoonlijk contact? Bel ons via <a href="tel:${PHONE}" class="hover:text-primary-500 transition hover:underline">${PHONE}
        </a> of mail naar <a href="mailto:${EMAIL}" class="hover:text-primary-500 transition hover:underline">${EMAIL}
  ...
  en: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: `Use the contact form via the menu. Prefer personal contact? Call us at <a href="tel:${PHONE}" class="hover:text-primary-500 transition hover:underline">${PHONE}
        </a> or email us at <a href="mailto:${EMAIL}" class="hover:text-primary-500 transition hover:underline">${EMAIL}
